...
public class MiniMap
{
	...
	public static float MINIMAP_TILE_SIZE = .75f;
	...
	public boolean justBeenChanged;
	...
	public void renderMinimapTile(double renderCol, double renderRow, int tileColor, Graphics g)
	{
		...
		g.fillRect((int)(renderCol * MINIMAP_TILE_SIZE), (int)(renderRow * MINIMAP_TILE_SIZE), (int)Math.ceil(MINIMAP_TILE_SIZE * sampleRate), (int)Math.ceil(MINIMAP_TILE_SIZE * sampleRate));
	}
}
